    ...
    <S.Container>
      {isSecondFloor ? (
        ...
        <>
          ...
          <RoomIndicator room="LAB15" top={250} left={2130}/>
          <RoomIndicator room="LAB16" top={220} left={2450}/>
          <RoomIndicator room="LAB17" top={570} left={2495}/>
          <RoomIndicator room="LAB18" top={570} left={2335}/>
          <RoomIndicator room="LAB19" top={590} left={2175}/>
          <RoomIndicator room="LAB20" top={590} left={2015}/>
          <RoomIndicator room="LAB22" top={570} left={1700}/>
          <RoomIndicator room="LAB21" top={570} left={1855}/>
        </>
      )}
      ...
      <S.ToggleWrap>
        <S.ToggleItem $isFocused={isSecondFloor} onClick={() => setSecondFloor(true)}>2층</S.ToggleItem>
        <S.ToggleItem $isFocused={!isSecondFloor} onClick={() => setSecondFloor(false)}>3층</S.ToggleItem>
      </S.ToggleWrap>
      
      <S.ConfirmAttend disabled={!isButtonEnabled} onClick={confirmAttend}>{ data.length === 0 ? "출석 승인" : `${data[data.length - 1].time} 승인` }</S.ConfirmAttend>
    </S.Container>
  );
};
