  ...
  return (
    <S.Container>
      <S.ContentWrap>
        <S.SectionWrap>
          ...
          >
            <S.TableHead>
              ...
              <S.TableColumn $flex="1.6">참여 여부</S.TableColumn>
            </S.TableHead>
            <S.TableContent>
              {Array.from({ length: 20 }).map(() => (
                <S.TableItem>
                  ...
                  <S.TableItemContent $flex="2">7:10</S.TableItemContent>
                  <S.TableItemContent $flex="2">8:50</S.TableItemContent>
                  <S.TableItemContent $flex="1.6">O</S.TableItemContent>
                </S.TableItem>
              ))}
            </S.TableContent>
          </MainSection>
        ...
        <S.SectionWrap>
          <MainSection title="실 이동 신청 목록" icon="Lab" href="/">
            <S.TableHead>
              <S.TableColumn $flex="1">학번</S.TableColumn>
              <S.TableColumn $flex="1">이름</S.TableColumn>
            ...
            <S.TableContent>
              {Array.from({ length: 20 }).map(() => (
                <S.TableItem>
                  <S.TableItemContent $flex="1">1210</S.TableItemContent>
                  <S.TableItemContent $flex="1">김엉한</S.TableItemContent>
                  <S.TableItemContent $flex="1.4">Lab 10 {'->'} Lab 20</S.TableItemContent>
                  <S.TableItemContent $notCenter $flex="7">
                    일단은 만들어 놓고 얘기할게요 이렇게 이렇게 이렇게 이렇게 이렇게 길어질수 있잖아요~~~~~~~~
                  </S.TableItemContent>
                </S.TableItem>
              ))}
            </S.TableContent>
